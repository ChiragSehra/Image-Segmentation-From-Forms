...
def preprocess(img_grey):
    ...
    cv2.imwrite("forms/horizontal.jpg", horizontal)
    cv2.waitKey(0)
    ...
    cv2.imwrite("forms/temp1.jpg", masked_img_inv)

    # Vertical libe removal
    img2 = cv2.imread("forms/temp1.jpg")
    ...
    vertical = cv2.erode(vertical, verticalStructure, (-1, -1), iterations=10)
    vertical = cv2.dilate(vertical, verticalStructure, (-1, -1))
    cv2.imwrite("forms/vertical.jpg", vertical)
    ...
    cv2.imwrite("forms/temp2.jpg", masked_img_inv2)

    #Remove spots from the final output
    image = cv2.imread('forms/temp2.jpg')
    # Denoising spots
